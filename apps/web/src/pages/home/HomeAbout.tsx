...
export function HomeAbout() {
  return (
    <>
      <CubeAnchor id="about" kf={{ x: 0.9, y: 0.24, scale: 0.28, face: "edge", glow: brand.palette.teal }}>
        <Band
          tone="light"
          accent="teal"
          index="01 — WHAT THE CLUB IS ABOUT"
          sigil={<Sg.CubeSigil size={16} />}
          code="ABT_01"
          rail="01 · HOME · 01001010 · SINCE 2020"
        >
            ...
            <div>
              <h2 className="t-h1 !text-[clamp(34px,4.4vw,68px)]">
                ...
                <span className="block">
                  <Outline>PEOPLE WHO BUILD.</Outline>
                </span>
              </h2>
              <Reveal>
              ...
              <Reveal delay={0.1}>
                <div className="my-7">
                  <Pullquote cite="_source · THE_ABOUT_PAGE · VERBATIM">Let's grow together!</Pullquote>
                </div>
              </Reveal>
              <Reveal delay={0.15}>
                <SpecSheet
