...
export function HomeResources() {
  return (
    <>
      <CubeAnchor id="resources" kf={{ x: 0.07, y: 0.8, scale: 0.28, face: "threeQuarter", glow: brand.palette.teal }}>
          ...
          <div className="relative grid md:grid-cols-[5fr_7fr] gap-10 items-start">
            ...
            <IndexList
              rows={resources.groups.slice(0, 6).map((g, i) => ({
                ...
                href: "/resources",
                sigil: [
                  <Sg.Node key="n" size={14} />,
                  <Sg.Shield key="s" size={14} />,
                  <Sg.Terminal key="t" size={14} />,
                  <Sg.Lambda key="l" size={14} />,
                  <Sg.Star4 key="q" size={14} />,
                  <Sg.Eye key="e" size={14} />,
                ][i],
              }))}
            />
          </div>
