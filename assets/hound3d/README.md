...
rim, red emissive eye slits. ~9.2k triangles, four nodes, no textures.
...
- `renders/`         v1…v5 iterations at three angles; `qa/loops/run5/hound_compare.png`
...
| Cheeks | x × 1.12 around local y −0.10 (σ 0.20); two r 0.19 spheres at (±0.43, −0.12, 0.14) | jaw muscles |
| Forehead | plane cut 30° leaning back through (0, 0.33, 0.26) head-local | the pitbull "stop" |
| Muzzle | rbox 0.74 × 0.46 × 0.46, r 0.17, centre y −0.12, sunk 0.26 into the front | blocky |
...
| Eyes | recess 0.25 × 0.062 × 0.08 at (±0.27, +0.11), tilted ∓12° (inner end lower) | strips 0.23 × 0.046, emissive 1.4 → 2.2 on hover |
| Brows | two rbox 0.38 × 0.085 × 0.22 at (±0.26, eye +0.09), tilt 14°, 0.035 proud | the frown |
| Ears | cropped prism, base 0.30 × 0.20, 0.19 tall, tip r 0.035, at x ±0.40, tilt 26° out, sunk 0.08 | pitbull crop |
...
slits · v5 eye slits 0.062 tall, SEG 36 — shipped.
