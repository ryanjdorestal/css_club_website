...
2. Move `../jjay_css_refs/` (51 MB) to `~/Desktop/jjay_css_refs/` (outside the repo); leave
   `../jjay_css_refs/README.md` listing what was there + the path; fix links in `DESIGN.md`, `docs/archive/**`.
