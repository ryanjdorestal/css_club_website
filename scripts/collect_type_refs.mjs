...
const S = [
  ["S01", "2026-06-24", "7.59.09"], ["S02", "2026-06-24", "7.59.17"],
  ["S03", "2026-06-24", "10.22.59"], ["S04", "2026-05-14", "1.19.40"],
  ["S05", "2026-05-06", "11.07.42"], ["S06", "2026-01-24", "8.26.01"],
  ["S07", "2026-01-10", "10.27.24"], ["S08", "2026-01-18", "1.20.58"],
  ["S09", "2025-12-19", "9.52.34"], ["S10", "2026-06-19", "5.40.45"],
  ["S11", "2026-06-19", "5.44.55"], ["S12", null, "3.19.38"],
  ["S13", null, "3.22.00"], ["S14", null, "3.22.53"],
];
...
for (const [id, date, time] of [...T, ...S]) {
  ...
  if (hits.length === 0) { console.log(`${id}: NOT FOUND (${date ?? ""} ${time})`); continue; }
